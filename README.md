...
| Primary focus | search helpers, result contracts, query composition |
...
- This repo currently publishes `@platform/search` as the legacy compatibility package id while the migration to `@gutu/search` is completed.
